        ...
        <AnimatePresence mode="wait">
          {isOpen ? <X size={24} /> : (
            <div className="relative flex items-center justify-center">
              ...
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 w-5 h-5 bg-[#C48B8B] text-white text-[9px] font-bold flex items-center justify-center rounded-full border-2 border-white shadow-md">
                  {unreadCount}
                </span>
              )}
            </div>
