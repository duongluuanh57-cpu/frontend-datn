...
export function VoucherBulkActionBar({ adminVouchers }: VoucherBulkActionBarProps) {
  const {
    selectedIds,
    isVi,
  ...
  return (
    <div style={{
      ...
      <span style={{ fontSize: '0.875rem', fontWeight: 600, color: '#f0e9e4' }}>
        {isVi ? `Đã chọn ${selectedIds.length} mã giảm giá` : `${selectedIds.length} vouchers selected`}
      </span>
