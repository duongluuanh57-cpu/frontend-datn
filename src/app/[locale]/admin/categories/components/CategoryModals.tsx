...
export function CategoryModals({ adminCategories }: CategoryModalsProps) {
  const {
    categoryToDelete,
    setCategoryToDelete,
    deleteMutation,
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
              ...
              <div style={{ flex: 1 }}>
                <h3 style={{ margin: 0, fontSize: '1.125rem', fontWeight: 700, color: 'var(--admin-text, #3d2e24)' }}>
                  {isVi ? 'Xác nhận xóa danh mục' : 'Confirm Delete Category'}
                </h3>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <Hash className="text-[#D4A5A5]" size={20} />
              </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ margin: '6px 0 0 0', fontSize: '0.875rem', lineHeight: '1.4', color: 'var(--admin-text-secondary, #6b564c)' }}>
                  {isVi
                    ? `Bạn có chắc chắn muốn xóa vĩnh viễn ${selectedIds.length} danh mục đã chọn? Thao tác này không thể hoàn tác.`
                    : `Are you sure you want to permanently delete the ${selectedIds.length} selected categories? This action cannot be undone.`}
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              {Array.from(selectedCategoryNames.entries()).filter(([id]) => selectedIds.includes(id)).map(([id, name]) => (
